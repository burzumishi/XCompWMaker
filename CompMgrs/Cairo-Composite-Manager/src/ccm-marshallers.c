...
void
ccm_cclosure_marshal_VOID__INT_INT (GClosure     *closure,
...
void
ccm_cclosure_marshal_STRING__POINTER (GClosure     *closure,
                                      GValue       *return_value G_GNUC_UNUSED,
                                      guint         n_param_values,
                                      const GValue *param_values,
                                      gpointer      invocation_hint G_GNUC_UNUSED,
...
void
ccm_cclosure_marshal_BOOLEAN__VOID (GClosure     *closure,
                                    GValue       *return_value G_GNUC_UNUSED,
                                    guint         n_param_values,
                                    const GValue *param_values,
                                    gpointer      invocation_hint G_GNUC_UNUSED,
...
void
ccm_cclosure_marshal_VOID__STRING_BOOLEAN (GClosure     *closure,
                                           GValue       *return_value G_GNUC_UNUSED,
                                           guint         n_param_values,
                                           const GValue *param_values,
                                           gpointer      invocation_hint G_GNUC_UNUSED,
...
void
ccm_cclosure_marshal_VOID__OBJECT_OBJECT_LONG_LONG_LONG (GClosure     *closure,
                                                         GValue       *return_value G_GNUC_UNUSED,
                                                         guint         n_param_values,
                                                         const GValue *param_values,
                                                         gpointer      invocation_hint G_GNUC_UNUSED,
                                                         gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__OBJECT_OBJECT_LONG_LONG_LONG) (gpointer     data1,
                                                                   gpointer     arg_1,
                                                                   gpointer     arg_2,
                                                                   glong        arg_3,
                                                                   glong        arg_4,
                                                                   glong        arg_5,
                                                                   gpointer     data2);
  register GMarshalFunc_VOID__OBJECT_OBJECT_LONG_LONG_LONG callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__OBJECT_OBJECT_LONG_LONG_LONG) (marshal_data ? marshal_data : cc->callback);
  ...
  callback (data1,
            ...
            g_marshal_value_peek_long (param_values + 5),
            data2);
}

/* VOID:POINTER,POINTER (ccm-marshallers.list:6) */
void
ccm_cclosure_marshal_VOID__POINTER_POINTER (GClosure     *closure,
                                            GValue       *return_value G_GNUC_UNUSED,
                                            guint         n_param_values,
                                            const GValue *param_values,
                                            gpointer      invocation_hint G_GNUC_UNUSED,
