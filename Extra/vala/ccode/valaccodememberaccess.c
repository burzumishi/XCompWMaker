...
ValaCCodeMemberAccess* vala_ccode_member_access_construct (GType object_type, ValaCCodeExpression* container, const gchar* member, gboolean pointer) {
	...
	_tmp0_ = container;
	vala_ccode_member_access_set_inner (self, _tmp0_);
	_tmp1_ = member;
	vala_ccode_member_access_set_member_name (self, _tmp1_);
	_tmp2_ = pointer;
	vala_ccode_member_access_set_is_pointer (self, _tmp2_);
	return self;
}
...
static void vala_ccode_member_access_real_write (ValaCCodeNode* base, ValaCCodeWriter* writer) {
	...
	vala_ccode_writer_write_string (_tmp5_, _tmp6_);
}
