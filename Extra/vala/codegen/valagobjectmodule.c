			...
			if (_tmp67_ == G_TYPE_CHECK_INSTANCE_CAST (_tmp68_, VALA_TYPE_SYMBOL, ValaSymbol)) {
				{
					...
					while (TRUE) {
						...
						prop = G_TYPE_CHECK_INSTANCE_TYPE (_tmp91_, VALA_TYPE_PROPERTY) ? ((ValaProperty*) _tmp91_) : NULL;
						_tmp92_ = prop;
						if (_tmp92_ == NULL) {
							...
							_tmp98_ = _tmp97_;
							_tmp99_ = vala_ccode_base_module_get_current_class ((ValaCCodeBaseModule*) self);
							_tmp100_ = _tmp99_;
							_tmp101_ = vala_symbol_get_full_name ((ValaSymbol*) _tmp100_);
							_tmp102_ = _tmp101_;
							_tmp103_ = g_strdup_printf ("Property `%s' not found in `%s'", _tmp98_, _tmp102_);
							_tmp104_ = _tmp103_;
							vala_report_error (_tmp95_, _tmp104_);
							_g_free0 (_tmp104_);
							_g_free0 (_tmp102_);
							_vala_code_node_unref0 (prop);
							_vala_code_node_unref0 (named_argument);
						...
						_tmp105_ = prop;
						_tmp106_ = vala_ccode_base_module_is_gobject_property ((ValaCCodeBaseModule*) self, _tmp105_);
						if (!_tmp106_) {
							ValaExpression* _tmp107_;
							ValaSourceReference* _tmp108_;
							ValaSourceReference* _tmp109_;
							ValaNamedArgument* _tmp110_;
							...
							_tmp109_ = _tmp108_;
							_tmp110_ = named_argument;
							_tmp111_ = vala_named_argument_get_name (_tmp110_);
							_tmp112_ = _tmp111_;
							_tmp113_ = g_strdup_printf ("Property `%s' not supported in Object (property: value) constructor ch" \
"ain up", _tmp112_);
							_tmp114_ = _tmp113_;
							vala_report_error (_tmp109_, _tmp114_);
							_g_free0 (_tmp114_);
							_vala_code_node_unref0 (prop);
							_vala_code_node_unref0 (named_argument);
							_vala_code_node_unref0 (arg);
						...
						_tmp120_ = _tmp119_;
						_tmp121_ = vala_data_type_compatible (_tmp117_, _tmp120_);
						if (!_tmp121_) {
							...
							_tmp134_ = _tmp133_;
							_tmp135_ = g_strdup_printf ("Cannot convert from `%s' to `%s'", _tmp129_, _tmp134_);
							_tmp136_ = _tmp135_;
	...
	_tmp137_ = expr;
	VALA_CODE_VISITOR_CLASS (vala_gobject_module_parent_class)->visit_method_call ((ValaCodeVisitor*) G_TYPE_CHECK_INSTANCE_CAST (self, VALA_TYPE_GTYPE_MODULE, ValaGTypeModule), _tmp137_);
}
