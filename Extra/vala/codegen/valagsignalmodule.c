			...
			if (_tmp11_ == _tmp14_) {
				...
				if (_tmp23_) {
					...
					if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp27_, VALA_TYPE_STRUCT)) {
						...
						st = _tmp31_;
						_tmp32_ = st;
						_tmp33_ = vala_struct_is_simple_type (_tmp32_);
						if (_tmp33_) {
						...
						_tmp41_ = _tmp40_;
						if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp41_, VALA_TYPE_ENUM)) {
							gchar* _tmp42_;
							_tmp42_ = g_strdup ("gint");
							result = _tmp42_;
							return result;
						} else {
							...
							if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp43_, VALA_TYPE_ARRAY_TYPE)) {
								gchar* _tmp44_;
								_tmp44_ = g_strdup ("gpointer");
								result = _tmp44_;
								return result;
							} else {
								ValaDataType* _tmp45_;
								_tmp45_ = t;
								if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp45_, VALA_TYPE_ERROR_TYPE)) {
									gchar* _tmp46_;
									_tmp46_ = g_strdup ("gpointer");
									result = _tmp46_;
									return result;
								}
							}
...
static ValaCCodeFunctionCall* vala_gsignal_module_real_get_signal_creation (ValaCCodeBaseModule* base, ValaSignal* sig, ValaTypeSymbol* type) {
	...
	_tmp19_ = sig;
	_tmp20_ = vala_code_node_get_attribute_string ((ValaCodeNode*) _tmp19_, "Signal", "run");
	run_type = _tmp20_;
	_tmp21_ = run_type;
