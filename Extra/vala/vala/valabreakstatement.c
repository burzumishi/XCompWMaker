...
static void vala_break_statement_real_accept (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	_tmp0_ = visitor;
	vala_code_visitor_visit_break_statement (_tmp0_, self);
}
...
static void vala_break_statement_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	_tmp0_ = codegen;
	vala_code_visitor_visit_break_statement ((ValaCodeVisitor*) _tmp0_, self);
}
...
static void vala_break_statement_instance_init (ValaBreakStatement * self) {
}
