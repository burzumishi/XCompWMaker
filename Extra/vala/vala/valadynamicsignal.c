...
static gboolean vala_dynamic_signal_real_check (ValaCodeNode* base, ValaCodeContext* context);
...
ValaDynamicSignal* vala_dynamic_signal_construct (GType object_type, ValaDataType* dynamic_type, const gchar* name, ValaDataType* return_type, ValaSourceReference* source_reference, ValaComment* comment) {
	...
	_tmp3_ = comment;
	self = (ValaDynamicSignal*) vala_signal_construct (object_type, _tmp0_, _tmp1_, _tmp2_, _tmp3_);
	_tmp4_ = dynamic_type;
	vala_dynamic_signal_set_dynamic_type (self, _tmp4_);
	return self;
}
