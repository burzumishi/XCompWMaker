...
static gboolean vala_binary_expression_real_check (ValaCodeNode* base, ValaCodeContext* context) {
									...
									if (_tmp819_ == VALA_BINARY_OPERATOR_IN) {
										...
										if (_tmp839_) {
											...
											if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp851_, VALA_TYPE_ARRAY_TYPE)) {
												...
												contains_method = G_TYPE_CHECK_INSTANCE_TYPE (_tmp883_, VALA_TYPE_METHOD) ? ((ValaMethod*) _tmp883_) : NULL;
												_tmp884_ = contains_method;
												if (_tmp884_ == NULL) {
													...
													gchar* _tmp893_ = NULL;
													gchar* _tmp894_;
													_tmp885_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
													_tmp886_ = _tmp885_;
													_tmp887_ = vala_binary_expression_get_right (self);
													_tmp888_ = _tmp887_;
													_tmp889_ = vala_expression_get_value_type (_tmp888_);
													_tmp890_ = _tmp889_;
													_tmp891_ = vala_code_node_to_string ((ValaCodeNode*) _tmp890_);
													_tmp892_ = _tmp891_;
													_tmp893_ = g_strdup_printf ("`%s' does not have a `contains' method", _tmp892_);
													_tmp894_ = _tmp893_;
													vala_report_error (_tmp886_, _tmp894_);
													_g_free0 (_tmp894_);
													_g_free0 (_tmp892_);
													vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
													result = FALSE;
												...
												_tmp895_ = contains_method;
												_tmp896_ = vala_method_get_parameters (_tmp895_);
												_tmp897_ = _tmp896_;
												...
												if (_tmp900_) {
													...
													_tmp905_ = _tmp904_;
													_tmp906_ = g_strdup_printf ("`%s' must have one parameter", _tmp905_);
													_tmp907_ = _tmp906_;
												...
												_tmp908_ = contains_method;
												_tmp909_ = vala_method_get_return_type (_tmp908_);
												_tmp910_ = _tmp909_;
												_tmp911_ = context;
												_tmp912_ = vala_code_context_get_analyzer (_tmp911_);
												_tmp913_ = _tmp912_;
												_tmp914_ = _tmp913_->bool_type;
												_tmp915_ = vala_data_type_compatible (_tmp910_, _tmp914_);
												if (!_tmp915_) {
													...
													_tmp917_ = _tmp916_;
													_tmp918_ = contains_method;
													_tmp919_ = vala_symbol_get_full_name ((ValaSymbol*) _tmp918_);
													_tmp920_ = _tmp919_;
													_tmp921_ = g_strdup_printf ("`%s' must return a boolean value", _tmp920_);
													_tmp922_ = _tmp921_;
													vala_report_error (_tmp917_, _tmp922_);
													_g_free0 (_tmp922_);
													_g_free0 (_tmp920_);
													vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
													result = FALSE;
												...
												_tmp926_ = _tmp925_;
												_tmp927_ = vala_member_access_new (_tmp924_, "contains", _tmp926_);
												_tmp928_ = _tmp927_;
												_tmp929_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
												_tmp930_ = _tmp929_;
												_tmp931_ = vala_method_call_new ((ValaExpression*) _tmp928_, _tmp930_);
												_tmp932_ = _tmp931_;
												_vala_code_node_unref0 (_tmp928_);
												contains_call = _tmp932_;
												_tmp933_ = contains_call;
												_tmp934_ = vala_binary_expression_get_left (self);
												_tmp935_ = _tmp934_;
												vala_method_call_add_argument (_tmp933_, _tmp935_);
												_tmp936_ = vala_code_node_get_parent_node ((ValaCodeNode*) self);
												_tmp937_ = _tmp936_;
												_tmp938_ = contains_call;
												vala_code_node_replace_expression (_tmp937_, (ValaExpression*) self, (ValaExpression*) _tmp938_);
												_tmp939_ = contains_call;
												_tmp940_ = context;
												_tmp941_ = vala_code_node_check ((ValaCodeNode*) _tmp939_, _tmp940_);
												result = _tmp941_;
										...
										_tmp942_ = context;
										_tmp943_ = vala_code_context_get_analyzer (_tmp942_);
										_tmp944_ = _tmp943_;
										_tmp945_ = _tmp944_->bool_type;
										vala_expression_set_value_type ((ValaExpression*) self, _tmp945_);
									} else {
										g_assert_not_reached ();
									}
								}
	...
	_tmp946_ = vala_code_node_get_error ((ValaCodeNode*) self);
	_tmp947_ = _tmp946_;
	result = !_tmp947_;
	return result;
}
