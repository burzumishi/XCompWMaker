...
#define VALA_SUBROUTINE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALA_TYPE_SUBROUTINE, ValaSubroutinePrivate))
enum  {
	VALA_SUBROUTINE_DUMMY_PROPERTY
};
...
ValaSubroutine* vala_subroutine_construct (GType object_type, const gchar* name, ValaSourceReference* source_reference, ValaComment* comment) {
	...
	_tmp2_ = comment;
	self = (ValaSubroutine*) vala_symbol_construct (object_type, _tmp0_, _tmp1_, _tmp2_);
	return self;
}
...
void vala_subroutine_set_return_block (ValaSubroutine* self, ValaBasicBlock* value) {
	...
	self->priv->_return_block = _tmp1_;
}
...
static void vala_subroutine_instance_init (ValaSubroutine * self) {
	self->priv = VALA_SUBROUTINE_GET_PRIVATE (self);
}
...
GType vala_subroutine_get_type (void) {
