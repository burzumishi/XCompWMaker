...
ValaExpressionStatement* vala_expression_statement_construct (GType object_type, ValaExpression* expression, ValaSourceReference* source_reference) {
	...
	_tmp1_ = expression;
	vala_expression_statement_set_expression (self, _tmp1_);
	return self;
}
...
static void vala_expression_statement_real_accept (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	_tmp0_ = visitor;
	vala_code_visitor_visit_expression_statement (_tmp0_, self);
}
...
static gboolean vala_expression_statement_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	_tmp8_ = vala_expression_statement_get_expression (self);
	_tmp9_ = _tmp8_;
	_tmp10_ = vala_code_node_get_error_types ((ValaCodeNode*) _tmp9_);
	_tmp11_ = _tmp10_;
	vala_code_node_add_error_types ((ValaCodeNode*) self, _tmp11_);
	_vala_iterable_unref0 (_tmp11_);
	_tmp12_ = vala_code_node_get_error ((ValaCodeNode*) self);
	_tmp13_ = _tmp12_;
	result = !_tmp13_;
	return result;
}
...
static void vala_expression_statement_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	_tmp3_ = codegen;
	vala_code_visitor_visit_expression_statement ((ValaCodeVisitor*) _tmp3_, self);
}
